...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\CitrixReceiver.exe" -Parameters "/INCLUDESSON /ENABLE_SSON=Yes /silent /STORE0=`"MSUDenver;https://citrix.msudenver.edu/Citrix/MSUDenver/Discovery;on;MSUDenver Citrix Site`"" -WindowStyle "Hidden" -PassThru
